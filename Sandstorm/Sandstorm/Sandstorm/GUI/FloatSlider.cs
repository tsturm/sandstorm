...
namespace Sandstorm.GUI
{
    public class FloatSlider
    {
        ...
        public FloatSlider(Widget parent, object propertyOwner, string propertyName, int posX, int posY, int width, float min, float max)
        {
            //Set property owner
            ...
            Value = (float)Property.GetValue(PropertyOwner, null);
        ...
        {
            //Update value
            Value = Min + ((Slider)widget).Value * Max;
