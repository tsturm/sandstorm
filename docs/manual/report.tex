...
%%% HEADERS & FOOTERS
\pagestyle{empty} % try also: empty , plain , headings , ruled , Ruled , companion
...
%Titel
\iffullfrontpage
	\include{include/titel_frontpage}
\else
	\input{include/titel_header}
\fi
