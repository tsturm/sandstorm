...
\newcommand{\docTypeRubric}{\glqq Was Sandkastenspiele mit der Frischluftzufuhr in Staedten zu tun haben\grqq}
...
\clearpage
\input{include/bestehende_arbeiten}
\clearpage
\input{include/konzept}
\clearpage
\input{include/grundlagen}
\clearpage
\input{include/kinect_anbindung}
\clearpage
\input{include/xna_renderer}
\clearpage
\input{include/partikelsystem}
\clearpage
\input{include/gui}
\clearpage
\input{include/zusammenfassung}
\clearpage
\input{include/ausblick}
\clearpage
 %and so on
